export const images = {
    ...
    intro_right: require("./Illustration.svg").default,
    // intro_right_mobile: require("./bg-pattern-intro-right-mobile.svg").default,
     snappy_process: require("./Image 2@2x_adobe_express.svg").default,
     people_first: require("./Image 3@2x_adobe_express.svg").default,
     affordable_prices: require("./Image 4@2x_adobe_express.svg").default,
